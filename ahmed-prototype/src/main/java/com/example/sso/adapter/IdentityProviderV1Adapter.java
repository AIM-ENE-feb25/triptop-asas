...
public class IdentityProviderV1Adapter implements IdentityProviderAdapter {

    private final RestTemplate restTemplate;
    private static final String LOGIN_URL = "https://triptop-identity.wiremockapi.cloud/login";

    public IdentityProviderV1Adapter(RestTemplate restTemplate) {
    ...
    public LoginResponse login(String username, String password) {
        ...
        String encryptedToken = encryptMd5(response.getToken());
